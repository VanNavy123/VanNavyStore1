...
if( ! function_exists( 'redux_apply_product_brand_taxonomy' ) ) {
	function redux_apply_product_brand_taxonomy( $brand_taxonomy ) {
		...
		if( isset( $media_center_theme_options['product_brand_taxonomy'] ) ) {
			$brand_taxonomy = $media_center_theme_options['product_brand_taxonomy'];
		}
...
if( ! function_exists( 'redux_apply_product_label_taxonomy' ) ) {
	function redux_apply_product_label_taxonomy( $label_taxonomy ) {
		...
		if( isset( $media_center_theme_options['product_label_taxonomy'] ) ) {
			$label_taxonomy = $media_center_theme_options['product_label_taxonomy'];
		}
