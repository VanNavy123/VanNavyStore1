			...
			$sections = array(
				...
				array(
					...
					'fields' => array(
						...
						array(
							'title' => __('Handheld Header', 'mediacenter'),
							'id' => 'handheld_header',
							'on' => __('Enabled', 'mediacenter'),
							'off' => __('Disabled', 'mediacenter'),
							'type' => 'switch',
				...
				array(
					...
					'fields' => array(
						...
						array(
							'title' => __('Handheld Footer', 'mediacenter'),
							'id' => 'handheld_footer',
							'on' => __('Enabled', 'mediacenter'),
							'off' => __('Disabled', 'mediacenter'),
							'type' => 'switch',
				...
				array(
					...
					'fields' 	=> array(
						...
						array(
							'title' 	=> esc_html__( 'Brand Attribute', 'mediacenter' ),
							'subtitle' 	=> esc_html__( 'Choose a product attribute that will be used as brands', 'mediacenter' ),
							'desc'  	=> esc_html__( 'Once you choose a brand attribute, you will be able to add brand images to the attributes', 'mediacenter' ),
						...
						array(
							'title'      => esc_html__( 'Label Attribute', 'mediacenter' ),
							'subtitle'   => esc_html__( 'Choose a product attribute that will be used as labels.', 'mediacenter' ),
							'desc'       => esc_html__( 'Once you choose a label attribute, you will be able to add text and background color to the attributes', 'mediacenter' ),
...
if( ! array_key_exists( 'media_center_theme_options' , $GLOBALS ) ) {
	$GLOBALS['media_center_theme_options'] = get_option( 'media_center_theme_options', array() );
}