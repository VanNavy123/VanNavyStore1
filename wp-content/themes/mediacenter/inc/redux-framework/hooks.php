...
add_filter( 'has_media_center_mobile_header', 		'rx_toggle_handheld_header' );
...
add_filter( 'has_media_center_mobile_footer', 		'rx_toggle_handheld_footer' );

/**
 * Shop Options
 */
add_filter( 'mc_is_catalog_mode_enabled',			'rx_change_catalog_mode' );
add_filter( 'mc_product_brand_taxonomy',			'redux_apply_product_brand_taxonomy' );
add_filter( 'mc_product_label_taxonomy',			'redux_apply_product_label_taxonomy' );
