...
if( is_woocommerce_activated() ) {
	...
	require get_template_directory() . '/inc/woocommerce/class-mc-product-taxonomies.php';
...
/**
 * Migrate Brands and Labels to Product Attributes
 */
require get_template_directory() . '/inc/classes/class-taxonomy-switcher.php';